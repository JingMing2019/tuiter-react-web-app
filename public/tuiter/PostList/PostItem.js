...
<!--                Post -->
                    <div class="card my-2 rounded-4">
                        <img src="${post.postImage}" class="card-img-top wd-rounded-top" alt="Post Image"/>
                        <div class="card-body">
                            <h6 class="card-title mb-0">${post.postTitle}</h6>
                            <p class="text-secondary card-text mb-0">${post.postContent}</p>
